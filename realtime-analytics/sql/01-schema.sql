CREATE TIMESERIES TYPE SensorReading TIMESTAMP ts TAGS (sensor_id STRING, location STRING, floor STRING) FIELDS (temperature DOUBLE, humidity DOUBLE, pressure DOUBLE) SHARDS 16 RETENTION 90 DAYS
