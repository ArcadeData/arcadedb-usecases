...
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c1') TO (SELECT FROM Product WHERE id = 'p1') SET purchasedAt = '2026-02-01 10:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c1') TO (SELECT FROM Product WHERE id = 'p2') SET purchasedAt = '2026-02-10 14:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c2') TO (SELECT FROM Product WHERE id = 'p1') SET purchasedAt = '2026-02-05 11:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c2') TO (SELECT FROM Product WHERE id = 'p2') SET purchasedAt = '2026-02-12 16:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c2') TO (SELECT FROM Product WHERE id = 'p5') SET purchasedAt = '2026-02-20 09:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c3') TO (SELECT FROM Product WHERE id = 'p3') SET purchasedAt = '2026-01-15 10:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c5') TO (SELECT FROM Product WHERE id = 'p3') SET purchasedAt = '2026-01-20 11:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c3') TO (SELECT FROM Product WHERE id = 'p4') SET purchasedAt = '2026-02-01 13:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c3') TO (SELECT FROM Product WHERE id = 'p6') SET purchasedAt = '2026-02-05 15:00:00';
CREATE EDGE PURCHASED FROM (SELECT FROM Customer WHERE id = 'c5') TO (SELECT FROM Product WHERE id = 'p1') SET purchasedAt = '2026-02-18 10:00:00';
-- LIVES_AT edges
